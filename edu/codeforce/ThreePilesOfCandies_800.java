...
public class ThreePilesOfCandies_800 {
    ...
    public static void main(String[] args) {
        ...
        while (numberOfTestcases > 0) {
            long firstPile = sc.nextLong();
            long secondPile = sc.nextLong();
            long thirdPile = sc.nextLong();

            long maxNumberOfCandiesEachGet = firstPile / 2 + secondPile / 2 + thirdPile / 2;
            maxNumberOfCandiesEachGet += (firstPile % 2 + secondPile % 2 + thirdPile % 2) / 2;

            System.out.println(maxNumberOfCandiesEachGet);
            numberOfTestcases--;
        }
